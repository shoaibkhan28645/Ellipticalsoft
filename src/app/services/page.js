...
export default function ServicesPage() {
  ...
  const services = [
    ...
    },
    {
      ...
      description:
        "Advanced data management and analytics to drive informed business decisions.",
      features: [
        "Big Data",
        "Data Warehousing",
        "ETL Pipelines",
    ...
    },
    {
      ...
      title: "AI & Automation",
      description:
        "Intelligent automation and AI solutions to streamline your business processes.",
      features: [
        "Machine Learning",
        "Process Automation",
        "Chatbots",
  ...
  const processSteps = [
    {
      ...
      title: "Discovery",
      description:
        "We analyze your requirements and business goals to create a tailored strategy.",
    },
    {
      number: "02",
      title: "Design",
      description:
        "Our team creates intuitive designs and architectures that align with your vision.",
    },
    {
      number: "03",
      title: "Development",
      description:
        "We build robust solutions using cutting-edge technologies and best practices.",
    },
    {
      number: "04",
      title: "Deployment",
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-[#6b6b6b] mb-12 leading-relaxed max-w-3xl mx-auto">
                Transform your business with our comprehensive range of
                technology services designed to drive growth and innovation.
              </p>
            </motion.div>
          </div>
        </section>
                  ...
                  <div className="relative z-10">
                    ...
                    <ul className="space-y-2 mb-6">
                      {service.features.map((feature, idx) => (
                        <li
                          key={idx}
                          className="flex items-center text-sm text-[#6b6b6b]"
                        >
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
                Let&apos;s discuss how our innovative solutions can help you
                achieve your goals.
              </p>
              <Link
                href="/contact"

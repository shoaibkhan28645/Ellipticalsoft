...
export default function Services() {
  ...
  return (
    <section className="relative w-full py-6 md:py-24 lg:pt-100">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-outfit font-bold mb-6 leading-tight">
              <span className="text-[#8d8d8d]">We Don't Just Offer</span>{" "}
          ...
          {/* Right column - Cards */}
          <div ref={cardsRef} className="lg:col-span-1">
            ...
            {isMobile ? (
              ...
              <div className="grid grid-cols-3 gap-4 lg:gap-6 auto-rows-auto items-start">
                {/* First column/section - 2 cards, vertically centered */}
                <div
                  className="col-span-1 flex flex-col gap-4 lg:gap-4 transition-transform duration-700 ease-out -mt-25"
                ...
                <div
                  className="col-span-1 flex flex-col gap-4 lg:gap-4 transition-transform duration-700 ease-out mt-8 lg:mt-25"
                ...
                <div
                  className="col-span-1 flex flex-col gap-4 lg:gap-4 transition-transform duration-700 ease-out mt-4 lg:-mt-25"
